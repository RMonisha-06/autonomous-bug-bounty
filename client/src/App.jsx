...
export default function App() {
  ...
  const [chatSize, setChatSize] = useState({ width: 360, height: 420 });
        ...
        {result && (
          <div className="space-y-12">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border">
              <h3 className="text-2xl font-semibold mb-6 text-emerald-700">🗺 Severity Heatmap</h3>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border space-y-6">
              <h3 className="text-3xl font-semibold text-emerald-700">🛡 Detected Vulnerabilities</h3>
        ...
        >
          ...
          <div ref={chatBoxRef} className="flex-1 overflow-y-auto p-3 space-y-2 text-sm bg-white">
            ...
            {chatHistory.map((msg, i) => (
              <div
  key={i}
  className={`p-2 rounded-lg max-w-[80%] ${msg.sender === "user" ? "bg-emerald-100 ml-auto text-right" : "bg-gray-300 text-left"}`}>
  {msg.text}
</div>
